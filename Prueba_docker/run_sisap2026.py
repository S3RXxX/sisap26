...
def main():
    ...
    parser.add_argument("--leaf_size",     type=int,   default=512,
                        help="Max points per leaf cluster (Cmax)")
    parser.add_argument("--min_leaf_size", type=int,   default=32,
                        help="Leaf merge threshold (Cmin)")
    parser.add_argument("--k_entry",       type=int,   default=12,
                        help="Diverse graph entry points")
    parser.add_argument("--entry_sample",  type=int,   default=3000,
                        help="Sample size for entry-point selection")
    parser.add_argument("--hash_bits",     type=int,   default=12,
                        help="LSH bits for HashPrune (<=16)")
    parser.add_argument("--reservoir_cap", type=int,   default=128,
    ...
    parser.add_argument("--final_prune",   type=int,   default=1,
                        help="Apply RobustPrune after HashPrune (0/1)")
    parser.add_argument("--back_edge",     type=int,   default=1,
