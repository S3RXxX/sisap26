...
#     --output    "/app/results/pipnn_results.h5"      \
#     --input "/app/data/wikipedia-small/benchmark-dev-wikipedia-bge-m3-small.h5"\
#     --task-description "/app/data/wikipedia-small/config.json"\
#     --bw      "${BEAM_WIDTH}"    \
